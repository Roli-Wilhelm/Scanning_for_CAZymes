...
OPTIONAL ARGUMENTS:
                ...
                -d	the folder containing your .CAZyhits file
...
if not POOL: 
	if np.size(FILE_Name)<2:
		...
		if Debug:
			print "You processing only one file entitled: "+FILE_Name[0]+'.CAZyhits'

		COUNT_DICT = {}
		SPACED_Name = re.sub(" ", "\ ", FILE_Name[0])
		...
		for key, value in COUNT_DICT.iteritems():
			output.write(FILE_Name[0]+"\t"+key+"\t"+str(value)+"\n")
